  ...
  return (
    <div className="kt-wizard-v3__nav">
      <div className="kt-wizard-v3__nav-items">
        <div className="kt-wizard-v3__nav-item" data-ktwizard-type="step" data-ktwizard-state={current === 0 && "current"}>
        ...
        <div className="kt-wizard-v3__nav-item" data-ktwizard-type="step" data-ktwizard-state={current === 1 && "current"}>
          <div className="kt-wizard-v3__nav-body">
            <div className="kt-wizard-v3__nav-label">
              <span>2</span> Address
            </div>
