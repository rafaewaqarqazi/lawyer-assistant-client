            ...
            <div className="form-group row position-relative">
                ...
                <div className="kt-avatar kt-avatar--outline">
                  <img src={user.profileImage && user.profileImage.filename ? `/images/${user.profileImage.filename}` : "/media/users/100_13.jpg"} alt="" className="kt-avatar__holder"/>
                  {
                    ...
                    <label className="kt-avatar__upload">
                      ...
                      <input type="file" name="profile_avatar" onChange={handleChangeProfile} accept="image/*"/>
                    </label>
                  }
              ...
              </div>
              {
                ...
                <Tooltip title='Edit Profile' placement='top'>
                  <button className="btn btn-label btn-icon position-absolute" onClick={() => setEdit(true)} style={{right: '20px', top: '-20px'}}><i className="fa fa-pen" /></button>
                </Tooltip>
              }
            ...
            </div>
            {
              !edit ?
                ...
                : <div className="row">
                  ...
                  >
                    {({status, handleSubmit, isSubmitting, resetForm, setFieldValue, values}) =>
...
export default connect(mapStateToProps, auth.actions)(AccountPersonalInfoDetails);